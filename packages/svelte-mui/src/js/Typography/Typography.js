...
import { create_ssr_component, spread } from "svelte/internal";
...
--letter-spacing: var(--theme-typography-${variant}-letter-spacing);`, variant === "overline"
	...
	return `${component === "p"
	? `<p${spread([props], "svelte-18vtsie")}>${slots.default ? slots.default({}) : ``}</p>`
	: `${component === "h1"
		? `<h1${spread([props], "svelte-18vtsie")}>${slots.default ? slots.default({}) : ``}</h1>`
		: `${component === "h2"
			? `<h2${spread([props], "svelte-18vtsie")}>${slots.default ? slots.default({}) : ``}</h2>`
			: `${component === "h3"
				? `<h3${spread([props], "svelte-18vtsie")}>${slots.default ? slots.default({}) : ``}</h3>`
				: `${component === "h4"
					? `<h4${spread([props], "svelte-18vtsie")}>${slots.default ? slots.default({}) : ``}</h4>`
					: `<p${spread([props], "svelte-18vtsie")}>${slots.default ? slots.default({}) : ``}</p>`}`}`}`}`}`;
});
