...
const Grid = index.create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${[
		"root " + index.escape($$props.class || "") + " svelte-vy4b7z",
