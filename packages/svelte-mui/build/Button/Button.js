import { S as SvelteComponent, i as init, g as globals, e as element, a as append, s as safe_not_equal, q as create_slot, y as space, x as attr, u as toggle_class, h as insert, z as listen, v as update_slot, t as transition_in, b as transition_out, k as detach, A as run_all, l as assign, o as exclude_internal_props, B as is_function, C as bubble } from '../index-b90fd758.js';
...
function create_fragment(ctx) {
	...
	const start_icon_slot = create_slot(start_icon_slot_template, ctx, /*$$scope*/ ctx[5], get_start_icon_slot_context);
	const default_slot_template = /*#slots*/ ctx[6].default;
	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[5], null);
	const end_icon_slot_template = /*#slots*/ ctx[6]["end-icon"];
	const end_icon_slot = create_slot(end_icon_slot_template, ctx, /*$$scope*/ ctx[5], get_end_icon_slot_context);
	...
	return {
		c() {
			...
			t2 = space();
			span3 = element("span");
			attr(span0, "class", "start icon svelte-1w1xcxq");
			attr(span1, "class", "label svelte-1w1xcxq");
			attr(span2, "class", "end icon svelte-1w1xcxq");
			attr(span3, "class", "ripple");
			button.disabled = /*disabled*/ ctx[2];
			attr(button, "class", button_class_value = "root " + /*variant*/ ctx[0] + " " + /*color*/ ctx[1] + " " + /*$$props*/ ctx[4].class + " svelte-1w1xcxq");
			toggle_class(button, "disabled", /*disabled*/ ctx[2]);
			toggle_class(button, "text", /*variant*/ ctx[0] === "text");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(button, "click", function () {
						if (is_function(/*createRipple*/ ctx[3])) /*createRipple*/ ctx[3].apply(this, arguments);
					}),
		...
		p(new_ctx, [dirty]) {
			...
			if (start_icon_slot) {
				if (start_icon_slot.p && dirty & /*$$scope*/ 32) {
					update_slot(start_icon_slot, start_icon_slot_template, ctx, /*$$scope*/ ctx[5], dirty, get_start_icon_slot_changes, get_start_icon_slot_context);
				}
			}
			...
			if (end_icon_slot) {
				if (end_icon_slot.p && dirty & /*$$scope*/ 32) {
					update_slot(end_icon_slot, end_icon_slot_template, ctx, /*$$scope*/ ctx[5], dirty, get_end_icon_slot_changes, get_end_icon_slot_context);
				}
			}
		...
		i(local) {
			if (current) return;
			transition_in(start_icon_slot, local);
			transition_in(default_slot, local);
			transition_in(end_icon_slot, local);
			current = true;
		},
		o(local) {
			transition_out(start_icon_slot, local);
			transition_out(default_slot, local);
			transition_out(end_icon_slot, local);
			current = false;
		},
		d(detaching) {
...
class Button extends SvelteComponent {
	constructor(options) {
		...
		init(this, options, instance, create_fragment, safe_not_equal, { variant: 0, color: 1, disabled: 2 });
	}
}
