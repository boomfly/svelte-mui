...
const Box = index.create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"root " + index.escape(classes) + index.escape($$props.class || "") + " svelte-1mq0jlx"}" style="${index.escape(style) + index.escape($$props.style || "")}">${slots.default ? slots.default({}) : ``}</div>`;
});
