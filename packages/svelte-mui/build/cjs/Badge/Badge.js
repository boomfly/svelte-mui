...
function create_fragment(ctx) {
	...
	const default_slot = index.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[4], null);
	...
	return {
		c() {
			...
			t1 = index.text(/*badgeContent*/ ctx[1]);
			index.attr(span0, "class", span0_class_value = "badge " + /*variant*/ ctx[0] + " svelte-reuneu");
			index.attr(span1, "class", span1_class_value = "root " + (/*$$props*/ ctx[2].class || "") + " svelte-reuneu");
		},
		m(target, anchor) {
			index.insert(target, span1, anchor);

			if (default_slot) {
				default_slot.m(span1, null);
			}

			index.append(span1, t0);
			index.append(span1, span0);
			index.append(span0, t1);
			current = true;
		},
		p(ctx, [dirty]) {
			if (default_slot) {
				if (default_slot.p && dirty & /*$$scope*/ 16) {
					index.update_slot(default_slot, default_slot_template, ctx, /*$$scope*/ ctx[4], dirty, null, null);
				}
			}

			if (!current || dirty & /*badgeContent*/ 2) index.set_data(t1, /*badgeContent*/ ctx[1]);

			if (!current || dirty & /*variant*/ 1 && span0_class_value !== (span0_class_value = "badge " + /*variant*/ ctx[0] + " svelte-reuneu")) {
				index.attr(span0, "class", span0_class_value);
			}

			if (!current || dirty & /*$$props*/ 4 && span1_class_value !== (span1_class_value = "root " + (/*$$props*/ ctx[2].class || "") + " svelte-reuneu")) {
				index.attr(span1, "class", span1_class_value);
			}
		},
		i(local) {
			if (current) return;
		...
		d(detaching) {
			if (detaching) index.detach(span1);
...
class Badge extends index.SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-reuneu-style")) add_css();
		index.init(this, options, instance, create_fragment, index.safe_not_equal, { class: 3, variant: 0, badgeContent: 1 });
	}
}
