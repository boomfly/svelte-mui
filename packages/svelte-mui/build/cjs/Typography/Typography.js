...
function create_else_block(ctx) {
	...
	const default_slot = index.create_slot(default_slot_template, ctx, /*$$scope*/ ctx[9], null);
	let p_levels = [/*props*/ ctx[1]];
	let p_data = {};

	for (let i = 0; i < p_levels.length; i += 1) {
		p_data = index.assign(p_data, p_levels[i]);
	}
	...
	return {
		c() {
			...
			index.set_attributes(p, p_data);
			index.toggle_class(p, "svelte-18vtsie", true);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (default_slot) {
				if (default_slot.p && dirty & /*$$scope*/ 512) {
					index.update_slot(default_slot, default_slot_template, ctx, /*$$scope*/ ctx[9], dirty, null, null);
				}
			}

			index.set_attributes(p, p_data = index.get_spread_update(p_levels, [dirty & /*props*/ 2 && /*props*/ ctx[1]]));
			index.toggle_class(p, "svelte-18vtsie", true);
		},
		i(local) {
			if (current) return;
...
function create_if_block_4(ctx) {
	...
	for (let i = 0; i < h4_levels.length; i += 1) {
		h4_data = index.assign(h4_data, h4_levels[i]);
	}
	...
	return {
		c() {
			h4 = index.element("h4");
			if (default_slot) default_slot.c();
			index.set_attributes(h4, h4_data);
			index.toggle_class(h4, "svelte-18vtsie", true);
		},
		m(target, anchor) {
			index.insert(target, h4, anchor);
		...
		p(ctx, dirty) {
			...
			index.set_attributes(h4, h4_data = index.get_spread_update(h4_levels, [dirty & /*props*/ 2 && /*props*/ ctx[1]]));
			index.toggle_class(h4, "svelte-18vtsie", true);
		},
		i(local) {
			if (current) return;
...
function create_if_block_3(ctx) {
	...
	for (let i = 0; i < h3_levels.length; i += 1) {
		h3_data = index.assign(h3_data, h3_levels[i]);
	}
	...
	return {
		c() {
			h3 = index.element("h3");
			if (default_slot) default_slot.c();
			index.set_attributes(h3, h3_data);
			index.toggle_class(h3, "svelte-18vtsie", true);
		},
		m(target, anchor) {
			index.insert(target, h3, anchor);
		...
		p(ctx, dirty) {
			...
			index.set_attributes(h3, h3_data = index.get_spread_update(h3_levels, [dirty & /*props*/ 2 && /*props*/ ctx[1]]));
			index.toggle_class(h3, "svelte-18vtsie", true);
		},
		i(local) {
			if (current) return;
...
function create_if_block_2(ctx) {
	...
	for (let i = 0; i < h2_levels.length; i += 1) {
		h2_data = index.assign(h2_data, h2_levels[i]);
	}
	...
	return {
		c() {
			h2 = index.element("h2");
			if (default_slot) default_slot.c();
			index.set_attributes(h2, h2_data);
			index.toggle_class(h2, "svelte-18vtsie", true);
		},
		m(target, anchor) {
			index.insert(target, h2, anchor);
		...
		p(ctx, dirty) {
			...
			index.set_attributes(h2, h2_data = index.get_spread_update(h2_levels, [dirty & /*props*/ 2 && /*props*/ ctx[1]]));
			index.toggle_class(h2, "svelte-18vtsie", true);
		},
		i(local) {
			if (current) return;
...
function create_if_block_1(ctx) {
	...
	for (let i = 0; i < h1_levels.length; i += 1) {
		h1_data = index.assign(h1_data, h1_levels[i]);
	}
	...
	return {
		c() {
			h1 = index.element("h1");
			if (default_slot) default_slot.c();
			index.set_attributes(h1, h1_data);
			index.toggle_class(h1, "svelte-18vtsie", true);
		},
		m(target, anchor) {
			index.insert(target, h1, anchor);
		...
		p(ctx, dirty) {
			...
			index.set_attributes(h1, h1_data = index.get_spread_update(h1_levels, [dirty & /*props*/ 2 && /*props*/ ctx[1]]));
			index.toggle_class(h1, "svelte-18vtsie", true);
		},
		i(local) {
			if (current) return;
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$new_props => {
		$$invalidate(14, $$props = index.assign(index.assign({}, $$props), index.exclude_internal_props($$new_props)));
...
class Typography extends index.SvelteComponent {
	constructor(options) {
		super();
