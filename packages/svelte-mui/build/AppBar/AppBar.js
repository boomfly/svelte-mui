import { S as SvelteComponent, i as init, e as element, a as append, s as safe_not_equal, l as assign, c as create_component, r as set_attributes, u as toggle_class, h as insert, m as mount_component, w as get_spread_update, t as transition_in, b as transition_out, k as detach, d as destroy_component, D as component_subscribe, o as exclude_internal_props, q as create_slot, v as update_slot } from '../index-b90fd758.js';
import { currentTheme } from '../styles/store.js';
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			toggle_class(header, "svelte-1qs4kul", true);
		},
		m(target, anchor) {
			insert(target, header, anchor);
			mount_component(paper, header, null);
			current = true;
		},
		p(ctx, [dirty]) {
			const paper_changes = {};
...
function instance($$self, $$props, $$invalidate) {
	let $currentTheme;
	component_subscribe($$self, currentTheme, $$value => $$invalidate(12, $currentTheme = $$value));
...
class AppBar extends SvelteComponent {
	constructor(options) {
		...
		init(this, options, instance, create_fragment, safe_not_equal, { position: 0, color: 1, headerStyle: 2 });
	}
}
